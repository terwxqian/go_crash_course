...
func (*SocialFollowers) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_cb6727b6dd898b06, []int{0}
}
...
func (dst *SocialFollowers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SocialFollowers.Merge(dst, src)
}
...
func (*Person) Descriptor() ([]byte, []int) {
	return fileDescriptor_person_cb6727b6dd898b06, []int{1}
}
...
func init() { proto.RegisterFile("person.proto", fileDescriptor_person_cb6727b6dd898b06) }

var fileDescriptor_person_cb6727b6dd898b06 = []byte{
